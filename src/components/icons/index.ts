/**
 * Shared Icon Components Module
 *
 * This module centralizes all shared SVG icon components to eliminate duplication
 * across the codebase and maintain consistent icon styling.
 *
 * All icons:
 * - Accept an optional className prop for styling customization
 * - Include aria-hidden="true" for accessibility
 * - Use currentColor for stroke to inherit text color
 * - Have standardized viewBox of "0 0 24 24"
 */
